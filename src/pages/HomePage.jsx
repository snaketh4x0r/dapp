      ...
      <div className="homePage">
        ...
        <div className="howItWorks">
          ...
          <div className="innerBox">
            ...
            <span className="boxDescription">
              You can upload any type of file such as music, video, images or
              text
            </span>
          </div>
          <div className="innerBox">
            ...
            <span className="boxDescription">
              You can price your files using any ERC20 token, or create a
              subscription to gain more user visibility.
            </span>
          </div>
        </div>
